...
return (
  <main className="member-garden-page">
    <section className="member-garden-shell">
      <header>
        <h1 className="member-garden-title">Member Garden</h1>
        <p className="member-garden-intro">
          Your private space for resources, programs, downloads, and support
          from The Nourished Garden & Farm.
        </p>
      </header>

      <div className="member-garden-grid">
        {/* KEEP YOUR EXISTING MEMBER CONTENT HERE */}

        <section className="member-garden-card">
